...
def gen_images(infile,n,s):
    ...
    for i in range(s,n):
        ...
        if 1>0:
            ...
            term_start = predseq['term_start'].iloc[i]
...
#gen_pages('temp.csv', nn,ss)
#gen_table_js('temp.csv', nn,0)
#gen_images('temp.csv', nn,ss)

###NEEED TO RERUN GENTABLE FROM 0!
